...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do seu Speed Pixel Chat que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador Speed Pixel Chat, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar Speed Pixel Chat\n"
  printf "   [1] Atualizar Speed Pixel Chat\n"
  printf "   [2] Deletar Speed Pixel Chat\n"
  printf "   [3] Bloquear Speed Pixel Chat\n"
  printf "   [4] Desbloquear Speed Pixel Chat\n"
  printf "   [5] Alter. dominio Speed Pixel Chat\n"
  printf "\n"
  read -p "> " option
